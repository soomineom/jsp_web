...
<% 
   String query="SELECT *from chart33";
   ...
   JFreeChart chart=ChartFactory.createBarChart3D("Puppy Chart-ALL","day","eat/drink",dataset,PlotOrientation.VERTICAL,true,true,false);
